...
Background: Base Url and cofigure json body
    ...
    * set pa_request_autofax_body.labOrder.collectionDate = dataGenerator.getRandomDateForCollectionDate()
    * set pa_request_autofax_body.labOrder.serviceDate = dataGenerator.getRandomDateForService()
